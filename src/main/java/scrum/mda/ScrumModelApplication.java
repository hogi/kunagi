...
public class ScrumModelApplication extends AGeneratorApplication {
	...
	public ComponentModel getGwtComponentsModel() {
		if (gwtComponentsModel == null) {
			...
			gwtComponentsModel.addComposite("RichtextConverter");
		}
	...
	public EntityModel getSprintModel() {
		if (sprintModel == null) {
			...
			sprintModel.addProperty("planingNote", String.class);
			sprintModel.addProperty("reviewNote", String.class);
			sprintModel.addProperty("retrospectiveNote", String.class);
		}
		return sprintModel;
	}
