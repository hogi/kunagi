...
public abstract class GAttribute
    ...
    public final AttributeDao getDao() {
        return attributeDao;
    }
    ...
    private static final Logger LOG = Logger.get(GAttribute.class);
    ...
    public static final void setProjectDao(scrum.server.project.ProjectDao projectDao) {
        GAttribute.projectDao = projectDao;
    }

    protected static AttributeDao attributeDao;

    public static final void setAttributeDao(AttributeDao attributeDao) {
        GAttribute.attributeDao = attributeDao;
    }
