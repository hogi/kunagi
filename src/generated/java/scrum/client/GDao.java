...
public abstract class GDao
    ...
    public final List<scrum.client.impediments.Impediment> getImpedimentsByDate(scrum.client.common.Date date) {
        List<scrum.client.impediments.Impediment> ret = new ArrayList<scrum.client.impediments.Impediment>();
        for (scrum.client.impediments.Impediment entity : impediments.values()) {
    ...
    public final List<scrum.client.impediments.Impediment> getImpedimentsBySolveDate(scrum.client.common.Date solveDate) {
        List<scrum.client.impediments.Impediment> ret = new ArrayList<scrum.client.impediments.Impediment>();
        for (scrum.client.impediments.Impediment entity : impediments.values()) {
    ...
    public final scrum.client.project.ProjectSprintSnapshot getProjectSprintSnapshotBySprint(scrum.client.sprint.Sprint sprint) {
        for (scrum.client.project.ProjectSprintSnapshot entity : projectSprintSnapshots.values()) {
    ...
    public final List<scrum.client.project.Project> getProjectsByEnd(scrum.client.common.Date end) {
        List<scrum.client.project.Project> ret = new ArrayList<scrum.client.project.Project>();
        for (scrum.client.project.Project entity : projects.values()) {
    ...
    public final List<scrum.client.project.Project> getProjectsByBegin(scrum.client.common.Date begin) {
        List<scrum.client.project.Project> ret = new ArrayList<scrum.client.project.Project>();
        for (scrum.client.project.Project entity : projects.values()) {
