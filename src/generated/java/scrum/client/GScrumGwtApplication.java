...
public abstract class GScrumGwtApplication
    ...
    public final void callPing( Runnable callback) {
        onServiceCall();
        getScrumService().ping(conversationNumber,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callLogin(java.lang.String username, java.lang.String password,  Runnable callback) {
        onServiceCall();
        getScrumService().login(conversationNumber, username, password,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callLogout( Runnable callback) {
        onServiceCall();
        getScrumService().logout(conversationNumber,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callChangePassword(java.lang.String oldPassword, java.lang.String newPassword,  Runnable callback) {
        onServiceCall();
        getScrumService().changePassword(conversationNumber, oldPassword, newPassword,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callResetPassword(java.lang.String userId,  Runnable callback) {
        onServiceCall();
        getScrumService().resetPassword(conversationNumber, userId,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callSelectProject(java.lang.String projectId,  Runnable callback) {
        onServiceCall();
        getScrumService().selectProject(conversationNumber, projectId,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callCloseProject( Runnable callback) {
        onServiceCall();
        getScrumService().closeProject(conversationNumber,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callSwitchToNextSprint( Runnable callback) {
        onServiceCall();
        getScrumService().switchToNextSprint(conversationNumber,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callRequestImpediments( Runnable callback) {
        onServiceCall();
        getScrumService().requestImpediments(conversationNumber,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callRequestAcceptedIssues( Runnable callback) {
        onServiceCall();
        getScrumService().requestAcceptedIssues(conversationNumber,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callRequestClosedIssues( Runnable callback) {
        onServiceCall();
        getScrumService().requestClosedIssues(conversationNumber,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callRequestRisks( Runnable callback) {
        onServiceCall();
        getScrumService().requestRisks(conversationNumber,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callRequestRequirementEstimationVotes(java.lang.String requirementId,  Runnable callback) {
        onServiceCall();
        getScrumService().requestRequirementEstimationVotes(conversationNumber, requirementId,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callRequestComments(java.lang.String parentId,  Runnable callback) {
        onServiceCall();
        getScrumService().requestComments(conversationNumber, parentId,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callRequestChanges(java.lang.String parentId,  Runnable callback) {
        onServiceCall();
        getScrumService().requestChanges(conversationNumber, parentId,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callChangeProperties(java.lang.String entityId, java.util.Map properties,  Runnable callback) {
        onServiceCall();
        getScrumService().changeProperties(conversationNumber, entityId, properties,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callCreateEntity(java.lang.String type, java.util.Map properties,  Runnable callback) {
        onServiceCall();
        getScrumService().createEntity(conversationNumber, type, properties,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callDeleteEntity(java.lang.String entityId,  Runnable callback) {
        onServiceCall();
        getScrumService().deleteEntity(conversationNumber, entityId,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callRequestEntityByReference(java.lang.String reference,  Runnable callback) {
        onServiceCall();
        getScrumService().requestEntityByReference(conversationNumber, reference,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callSetSelectedEntitysIds(java.util.Set ids,  Runnable callback) {
        onServiceCall();
        getScrumService().setSelectedEntitysIds(conversationNumber, ids,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callSleep(long millis,  Runnable callback) {
        onServiceCall();
        getScrumService().sleep(conversationNumber, millis,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callUpdateSystemMessage(scrum.client.admin.SystemMessage systemMessage,  Runnable callback) {
        onServiceCall();
        getScrumService().updateSystemMessage(conversationNumber, systemMessage,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callSearch(java.lang.String text,  Runnable callback) {
        onServiceCall();
        getScrumService().search(conversationNumber, text,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callActivateRequirementEstimationVoting(java.lang.String requirementId,  Runnable callback) {
        onServiceCall();
        getScrumService().activateRequirementEstimationVoting(conversationNumber, requirementId,  new DefaultCallback<DataTransferObject>(callback));
    }
    ...
    public final void callRequestForum( Runnable callback) {
        onServiceCall();
        getScrumService().requestForum(conversationNumber,  new DefaultCallback<DataTransferObject>(callback));
    }
