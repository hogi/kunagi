...
public class TextBundleViews {
    ...
    public String issues() {
        return "<table>\n<tr>\n\n<td width=\"33%\" valign=\"top\">\n\n<h3>Types of Issues</h3>\n<p>The Issue view is a place to keep track of feedback, bugs and ideas for the project.</p>\n\n<p>It is divided into four parts, namely <em>Issue Inbox</em>, <em>Bugs</em>,\n<em>Ideas</em> and <em>Closed Issues</em>. When an Issue is submitted, it\nis created in the Inbox.</p>\n\n<h3>Product Owner processes the Inbox</h3>\n<p>The Product Owner reviews all Issues in the Inbox and decides how to handle them. He can\nchoose to <em>suspend</em> them if he wants to postpone a decision.</p>\n\n<td>\n\n<td width=\"20px\"></td>\n<td width=\"33%\" valign=\"top\">\n\n<p>Otherwise he selects toconvert the Issue to a <em>Bug</em> or an <em>Idea</em>.</p>\n\n<h3>Team fixes Bugs</h3>\n<p><em>Bugs</em> are the Team\'s domain and are usually flaws of part work results that\nhave been discovered only now. When a Sprint Planning Meeting is held and the Team decides\non how much work they can handle during the next Sprint, they should also take work into\naccount that has to be invested into bug solving. In case a bug\'s scope is too big or\notherwise cloudy, it might be a better Idea to create a Story from it.\n</p>\n</td>\n\n<td width=\"20px\"></td>\n<td width=\"33%\" valign=\"top\">\n\n<h3>Product Owner manages Ideas</h3>\n<p><em>Ideas</em> on the other hand are to be handled by the Product Owner. An idea is\ncreated feedback is accepted, but a Story for the Product Backlog is yet to be created.\n</p>\n\n<h3>Closed Issues</h3>\n<p><em>Closed Issues</em> are all Issues that have been sufficiently addressed.\nSolutions of issues include resolution of the issue, identifying it as a dublicate\nof another issue, creating stories from them and refusing to address them.</p>\n</td>\n\n</tr>\n</table>";
    }
